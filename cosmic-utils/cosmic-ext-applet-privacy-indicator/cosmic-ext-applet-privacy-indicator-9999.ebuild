...
DESCRIPTION="Cosmic Privacy Indicator"
...
EGIT_REPO_URI="https://github.com/D-Brox/cosmic-ext-applet-privacy-indicator.git"
...
src_install() {
	exeinto /usr/bin
	doexe "$(cargo_target_dir)/cosmic-ext-applet-privacy-indicator"
