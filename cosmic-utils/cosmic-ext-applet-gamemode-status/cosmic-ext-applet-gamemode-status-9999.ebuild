...
DESCRIPTION="GameMode Status Cosmic Applet"
...
EGIT_REPO_URI="https://github.com/D-Brox/cosmic-ext-applet-gamemode-status.git"
...
src_install() {
	exeinto /usr/bin
	doexe "$(cargo_target_dir)/cosmic-ext-applet-gamemode-status"
